...
# Generated by qmake (2.01a) (Qt 4.7.2) on: Thu Mar 22 01:29:01 2012
# Project:  beagletomb.pro
# Template: app
# Command: /usr/bin/qmake -nocache QMAKE_CFLAGS_RELEASE=-g\ -O2 QMAKE_CFLAGS_DEBUG=-g\ -O2 QMAKE_CXXFLAGS_RELEASE=-g\ -O2 QMAKE_CXXFLAGS_DEBUG=-g\ -O2 QMAKE_LFLAGS_RELEASE=-Wl,-Bsymbolic-functions QMAKE_LFLAGS_DEBUG=-Wl,-Bsymbolic-functions QMAKE_STRIP=: PREFIX=/usr -o Makefile beagletomb.pro
#############################################################################
...
Makefile: beagletomb.pro /usr/share/qt4/mkspecs/linux-g++/qmake.conf /usr/share/qt4/mkspecs/common/g++.conf \
	...
	$(QMAKE) -nocache QMAKE_CFLAGS_RELEASE=-g\ -O2 QMAKE_CFLAGS_DEBUG=-g\ -O2 QMAKE_CXXFLAGS_RELEASE=-g\ -O2 QMAKE_CXXFLAGS_DEBUG=-g\ -O2 QMAKE_LFLAGS_RELEASE=-Wl,-Bsymbolic-functions QMAKE_LFLAGS_DEBUG=-Wl,-Bsymbolic-functions QMAKE_STRIP=: PREFIX=/usr -o Makefile beagletomb.pro
